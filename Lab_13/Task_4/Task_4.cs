...
namespace Lab13
{
    public partial class Task_4 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    // Стан 0: тільки прапор України
                    pictureBox1.Visible = true;
                    pictureBox2.Visible = false;
                    break;

                case 1:
                    // Стан 1: прапор норвегії поруч (праворуч)
                    pictureBox1.Visible = true;
                    pictureBox2.Visible = true;
                    pictureBox2.Location = new Point(356, 376);
                    break;

                case 2:
                    // Стан 2: прапор норвегії зверху
                    pictureBox1.Visible = true;
                    pictureBox2.Visible = true;
                    pictureBox2.Location = new Point(153, 297);
                    break;
            }
